...
The purpose of this module is to create security group for rds instance.

## Dependency 
### This module has a few dependencies:
1. Terraform version 1.0.0
2. VPC module for vpc_id and vpc_cidr_blocks outputs.
...
terraform {
  backend "s3" {
    ...
    region = "us-west-2"
    key = "us-west-2/rds/sg-rds/terraform.tfstate"
  }
}
...
variable terraform_module {
  type        = string
  default     = "macewan/onica-poc-modules/aws/sg-rds"
