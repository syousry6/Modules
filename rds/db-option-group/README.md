...
# RDS Configuration Module (Option Group)

## Purpose of This Module

The purpose of this module is to create configuration option group.
...
terraform {
  backend "s3" {
    ...
    region = "us-west-2"
    key = "us-west-2/rds/db-option-group/terraform.tfstate"
  }
}
...
variable terraform_module {
  type        = string
  default     = "macewan/onica-poc-modules/aws/rds/db-option-group"
