...
# Change Assistant Module

## Purpose of This Module

The purpose of this module is to create EC2 instances for Change Assistant Servers.
...
module "change-assistant" {
  source                      = "git::git@github.com:macewanu/onica-poc-modules.git//aws/change-assistant?ref=v0.1.0"
  ...
  private_ips                 = ["10.64.96.167", "10.64.97.133"]
  ec2_tcp_allowed_ports       = ["3389"]
...
terraform {
  ...
  backend "s3" {
    ...
    region = "us-west-2"
    key = "us-west-2/change-assistant/terraform.tfstate"
  }
}
```
...
variable "name" {
  type        = string
  default     = "change-assistant"
  description = "The name of the module"
}

variable terraform_module {
  type        = string
  default     = "macewan/onica-poc-modules/aws/change-assistant"
